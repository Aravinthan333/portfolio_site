  ...
  return (
    <section className="relative overflow-hidden py-10 sm:py-14">
      ...
      <div className="section-wrap relative">
        <ScrollReveal>
          <header className="mb-4 flex items-center justify-center gap-3 text-center sm:mb-5 sm:gap-3.5">
          ...
          <p className="section-desc mx-auto mb-10 max-w-xl text-center sm:mb-12">
            {subtitle}
          </p>
        </ScrollReveal>

        <div className="mx-auto grid max-w-6xl gap-4 lg:grid-cols-[1.35fr_auto_0.85fr] lg:items-stretch lg:gap-0">
          <ScrollReveal delay={0.06} className="h-full min-w-0 lg:pr-8">
            <div className="relative h-full overflow-hidden rounded-xl border border-[rgba(15,23,42,0.06)] bg-white/90 p-5 shadow-[var(--shadow-md)] sm:p-7 lg:p-8">
              <div
          ...
          <ScrollReveal delay={0.1} className="h-full min-w-0 lg:pl-8">
            <aside className="relative flex h-full min-h-[18rem] flex-col overflow-hidden rounded-xl border border-[rgba(59,130,246,0.18)] bg-white/70 shadow-[var(--shadow-md)] lg:min-h-0">
              ...
              <div className="relative flex flex-1 flex-col items-center justify-center px-6 py-8 text-center sm:px-8 sm:py-10">
                ...
                <p className="mt-3 max-w-[16rem] text-sm leading-relaxed text-[var(--fg-muted)]">
                  {preferBody}
                </p>
                <div className="mt-7 w-full max-w-[14rem]">
                  <BookCallButton
