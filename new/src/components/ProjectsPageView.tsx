        ...
        <div className="mx-auto grid max-w-6xl gap-5 sm:grid-cols-2 lg:gap-6">
          {projects.map((project, index) => (
            <ScrollReveal key={project.slug} delay={index * 0.05}>
              ...
              >
                <div className="relative aspect-[16/10] overflow-hidden bg-gradient-to-br from-[var(--blue-50)] via-white to-[var(--blue-100)]">
                ...
                <div className="p-5 sm:p-6">
                  <div className="flex items-start justify-between gap-3">
                    <div>
                      ...
                      <h2 className="font-display mt-2 text-[1.4rem] font-semibold leading-[1.12] tracking-tight text-[var(--fg)] transition-colors group-hover:text-[var(--blue-600)] sm:text-[1.6rem]">
                        {project.title}
                      </h2>
                    </div>
                    <span className="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-[var(--blue-200)] bg-white text-[var(--blue-600)] shadow-[var(--shadow-sm)] transition-colors group-hover:border-[var(--blue-400)] group-hover:bg-[var(--blue-50)]">
                  ...
                  <span className="mt-5 inline-flex items-center gap-1 text-sm font-medium text-[var(--blue-600)]">
                    {viewCaseStudyLabel}
